...
<div class="center article">
	<h1>Logo</h1>
	<p>
		The United Nations Decade on Biodiversity logo is available in the six United Nations languages (العربية - En - Es - Fr - Ру - 中文), as well as Catalan, Dutch, Portuguese and Turkish (courtesy of Governments and our Partners).
The logo is available for use under certain conditions explained in the <a href="">Brand Usage Guidelines (PDF)</a> for the United Nations Decade on Biodiversity. Usage of the logo requires completion of the <a href="">Waiver of Liability</a>.

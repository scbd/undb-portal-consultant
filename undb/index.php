	...
	<div id="welcome">
		...
		<div id="message">
			<div class="center">
				<h1>Welcome</h1>
				<p>
						Living in Harmony with Nature - the United
						Nations Decade on Biodiversity contributes
	...
	<div class="space wide">
		<h4>Partners</h4>
		<a href="" class="button blue">Become a Partner</a>
	</div>
	...
	<footer id="homeFooter">
		<div class="center">
			...
			<ul class="col-xs-6 col-sm-4 col-md-2">
				...
				<li><a href="">By countries</a></li>
				<li><a href="">By UN organizations</a></li>
			...
			<ul class="col-xs-6 col-sm-4 col-md-2">
				...
				<li><a href="">Register your action</a></li>
				<li><a href="">Become a UNDB Partner</a></li>
			</ul>			

		</div>
		<span class="copyright">Ⓒ CBD Secretariat</span>
